...
describe('Ficha Management Component', () => {
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [RouterTestingModule.withRoutes([{ path: 'ficha', component: FichaComponent }]), HttpClientTestingModule],
  ...
  describe('trackId', () => {
    it('Should forward to fichaService', () => {
      const entity = { id: 123 };
      jest.spyOn(service, 'getFichaIdentifier');
      const id = comp.trackId(0, entity);
      expect(service.getFichaIdentifier).toHaveBeenCalledWith(entity);
