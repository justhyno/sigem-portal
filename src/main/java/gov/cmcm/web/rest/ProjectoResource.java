...
public class ProjectoResource {
     ...
     * @return the {@link ResponseEntity} with status {@code 201 (Created)} and with body the new projectoDTO, or with status {@code 400 (Bad Request)} if the projecto has already an ID.
     ...
     * @return the {@link ResponseEntity} with status {@code 200 (OK)} and with body the updated projectoDTO,
     * or with status {@code 400 (Bad Request)} if the projectoDTO is not valid,
     * or with status {@code 500 (Internal Server Error)} if the projectoDTO couldn't be updated.
     * @throws URISyntaxException if the Location URI syntax is incorrect.
     */
    ...
    /**
     * {@code PATCH  /projectos/:id} : Partial updates given fields of an existing projecto, field will ignore if it is null
     *
     * @param id the id of the projectoDTO to save.
     * @param projectoDTO the projectoDTO to update.
     * @return the {@link ResponseEntity} with status {@code 200 (OK)} and with body the updated projectoDTO,
     * or with status {@code 400 (Bad Request)} if the projectoDTO is not valid,
     * or with status {@code 404 (Not Found)} if the projectoDTO is not found,
     * or with status {@code 500 (Internal Server Error)} if the projectoDTO couldn't be updated.
     * @throws URISyntaxException if the Location URI syntax is incorrect.
     */
     ...
     * @return the {@link ResponseEntity} with status {@code 200 (OK)} and the list of projectos in body.
     */
     ...
     * @return the {@link ResponseEntity} with status {@code 200 (OK)} and with body the projectoDTO, or with status {@code 404 (Not Found)}.
     */
